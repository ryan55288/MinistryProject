...
(function () {
	...
	ParticleNetworkAnimation.prototype.init = function (element) {
		// this.el = element;
		...
		// Create a fixed point particle at a specific position
		// this.fixedParticle = new Particle(this, this.canvas.width / 2, this.canvas.height / 2);
		// this.fixedParticle.velocity = { x: 200, y: 200 };
		// this.fixedParticle.particleColor = "#FF0000";  // 設置固定點的顏色為紅色
		// this.fixedParticle.radius = 5;  // 增加固定點的半徑
		// this.particleNetwork.particles.push(this.fixedParticle);
	...
	ParticleNetworkAnimation.prototype.bindUiActions = function () {
		var self = this;
	...
	ParticleNetworkAnimation.prototype.sizeCanvas = function () {
